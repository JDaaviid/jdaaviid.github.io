...
function dibujar_escena(){
    ...
    //SUELO
    const material_suelo = new THREE.MeshNormalMaterial({ wireframe: false, flatShading: false});
    ...
    //FIGURA 
    //const material_figura = new THREE.MeshNormalMaterial({ wireframe: false, flatShading: false});
    ...
    //const material_pinzas = new THREE.MeshNormalMaterial({ wireframe: false, flatShading: false});
