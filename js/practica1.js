...
void main(){
    gl_Position = vec4(posicion,1.0);
    gl_PointSize = 10.0;
    float distanciaAlCentro = sqrt((posicion[0]*posicion[0]) + (posicion[1]*posicion[1]));
    distanciaAlCentro = distanciaAlCentro/2.0;
    color = vec3(1.0-distanciaAlCentro , 1.0-distanciaAlCentro, 1.0-distanciaAlCentro);
}
`;  
...
function main(){
    ...
    // Obtener la ubicación de la variable variable del color
    //colorFragmento = gl.getAttribLocation(gl.program,"color");
